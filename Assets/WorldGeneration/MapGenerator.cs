...
public class MapGenerator : MonoBehaviour {
    ...
    //A different overload from the standard GenerateMapData, specifically for passing values in from MainMenuController.
    ...
    MapData GenerateMapData2(Vector2 centre)
    {
